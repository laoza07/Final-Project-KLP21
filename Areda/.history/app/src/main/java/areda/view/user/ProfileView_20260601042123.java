...
public class ProfileView extends StackPane {
    ...
    private HBox createHeader() {
        ...
        title.setTextFill(Color.web("#000000")); // HITAM
    ...
    private HBox createHighlightCard() {
        ...
        hlName.setTextFill(Color.web("#000000")); // HITAM

        hlEmail = new Label();
        hlEmail.setTextFill(Color.web("#000000")); // HITAM
        hlEmail.setFont(Font.font("Arial", 14));

        hlLocation = new Label();
        hlLocation.setFont(Font.font("Arial", 14));
        hlLocation.setTextFill(Color.web("#000000")); // HITAM
    ...
    private VBox createDataTableSection() {
        ...
        ((Label) titleBox.getChildren().get(1)).setTextFill(Color.web("#000000")); // HITAM
    ...
    private void refreshUI() {
        ...
        hlName.setText(p.nama.isEmpty() ? "Belum diisi" : p.nama);
        hlEmail.setText(p.email);
        hlLocation.setText(p.domisili.isEmpty() ? "Belum diisi" : p.domisili);
    ...
    private VBox createDataRow(String icon, String label, String value) {
        ...
        lblName.setTextFill(Color.web("#000000")); // HITAM
        lblName.setFont(Font.font("Arial", 14));

        Label lblVal = new Label(value.isEmpty() ? "Belum diisi" : value);
        lblVal.setFont(Font.font("Arial", FontWeight.BOLD, 14));
        lblVal.setTextFill(Color.web("#000000")); // HITAM

        row.getChildren().addAll(lblIcon, lblName, lblVal);

        Line line = new Line(0, 0, 800, 0);
        line.setStroke(Color.web("#EDF2F7"));
        rowBox.getChildren().addAll(row, line);
