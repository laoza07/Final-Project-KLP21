...
public abstract class BaseDashboardLayout extends BorderPane {
    protected Runnable onLogout;
    protected String currentUsername;
    protected VBox sidebar;
    protected StackPane contentArea;
    protected VBox navMenu;

    public BaseDashboardLayout(Runnable onLogout, String username) {
    ...
    protected abstract void initializeDefaultView();
    ...
    protected Button createNavButton(String icon, String text, boolean isActive) {
    ...
    protected void updateActiveButton(Button activeBtn, VBox container) {
