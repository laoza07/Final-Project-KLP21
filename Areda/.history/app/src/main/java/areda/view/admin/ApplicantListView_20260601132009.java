...
public class ApplicantListView extends StackPane {
    ...
    private void setupTableColumns() {
        ...
        colName.setCellValueFactory(data -> new SimpleStringProperty(data.getValue().namaPelamar));
    ...
    private void showDetailModal(Lamaran app) {
        ...
        nameBox.setAlignment(Pos.CENTER_LEFT);
        AvatarComponent avatar = new AvatarComponent(app.namaPelamar, 45);
        ...
        Label emailLbl = new Label(app.emailPelamar);
        ...
        Label cvLabel = new Label(
                (app.cvPath == null || app.cvPath.isEmpty()) ? "❌ Belum ada CV" : "📄  " + app.cvPath);
        cvLabel.setWrapText(true);
        cvLabel.setMaxWidth(200);
        cvLabel.setTextFill(Color.web("#2D3748"));

        Label mlLabel = new Label(
                (app.motletPath == null || app.motletPath.isEmpty()) ? "❌ Belum ada ML" : "📄  " + app.motletPath);
