...
public class Lamaran implements Serializable {
    ...
    public Lamaran(String idLamaran, String idLowongan, String namaPelamar, String emailPelamar, String teleponPelamar,
            String tentangPelamar, String tanggal, String statusTahapan, String cvPath, String motletPath) {
